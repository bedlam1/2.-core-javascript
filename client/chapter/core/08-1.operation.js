...
// 삼항 연산자
let ternary = a>10 ? '크다' : '작다';       // 참이면 왼쪽, 거짓이면 오른쪽
console.log(ternary);
...
let onlyWorkDefaultValues2 = [1,2,3].concat([4,5,6]);   // 옛날 방식
...
console.log(...first, ...second);  // 1 2 3 4 5 6 >> spread syntax
console.log([...first, ...second]); // [1,2,3,4,5,6]

// rest parameter >> 나중에 배움
function sum(...rest){
    console.log(rest);
}
